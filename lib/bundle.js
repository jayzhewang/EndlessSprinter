	...
	var GameView = function () {
	  ...
	  _createClass(GameView, [{
	    ...
	    value: function explode() {
	      this.ctx.clearRect(this.sprinterCoords[0] - 40, this.sprinterCoords[1] - 40, this.sprinterCoords[2] + 80, this.sprinterCoords[3] + 80);
	      this.ctx.fillStyle = '#f2f2f2';
	      this.ctx.fillRect(this.sprinterCoords[0] - 40, this.sprinterCoords[1] - 40, this.sprinterCoords[2] + 80, this.sprinterCoords[3] + 80);
	      this.ctx.drawImage(explosion, explodeCoords[this.idx][0], explodeCoords[this.idx][1], 95, 95, this.sprinterCoords[0] - 40, this.sprinterCoords[1] - 40, this.sprinterCoords[2] + 80, this.sprinterCoords[3] + 80);
	      if (this.idx === 15) {

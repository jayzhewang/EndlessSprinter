	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function draw(ctx) {
	      ...
	      var score = Math.floor((elapsedTime - this.startTime) / 1000);
	      ctx.clearRect(0, 0, 1334, 750);
	      ctx.fillStyle = '#f2f2f2';
	      ctx.fillRect(0, 0, 1334, 750);
	      ctx.font = "50px Georgia";
	      ctx.strokeText('score: ' + score, 570, 40);
...
/***/ function(module, exports) {
	...
	var Sprinter = function () {
	  function Sprinter() {
	    ...
	    this.velocity = 4;
	    this.startPixels = [0, 0, 0, 0, 66, 66, 66, 66, 264, 264, 264, 264, 132, 132, 132, 132, 198, 198, 198, 198, 330, 330, 330, 330, 396, 396, 396, 396, 594, 594, 594, 594, 528, 528, 528, 528, 462, 462, 462, 462];
	    this.startIdx = 0;
	  }
	...
	var Land = function () {
	  ...
	  _createClass(Land, [{
	    ...
	    value: function draw(ctx) {
	      ...
	      } else if (this.moveSpeed === 4.5 && this.currentPieceNumber < 20) {
	        ctx.font = "50px Georgia";
